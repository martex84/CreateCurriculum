...
import * as importarInformacoesFile from "@/shared/infra/config/importarInformacoesEnv";
...
describe("ImportarInformacoes", () => {
  test("Valida se ocorre reconhece a falha na configuração do env", () => {
    ...
    const { erros, importarInformacoesEnv: importarInformacoes } =
      importarInformacoesFile;
